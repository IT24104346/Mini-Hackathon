          ...
          <nav className="hidden md:flex items-center gap-1.5">
            ...
            <div className="ml-3 pl-3 border-l border-gray-200 flex items-center gap-2">
              {isAuthenticated && user ? (
                ...
                <Link
                  to="/login"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-blue-50 text-slate-700 hover:text-blue-700 border border-gray-200 transition text-xs font-semibold"
                >
          ...
          <div className="pt-2 border-t border-gray-200 flex items-center justify-between">
            {isAuthenticated && user ? (
              ...
              <Link
                to="/login"
                onClick={() => setIsMobileMenuOpen(false)}
                className="w-full flex items-center justify-center gap-1.5 py-2 rounded-lg bg-blue-600 text-white text-xs font-semibold"
              >
